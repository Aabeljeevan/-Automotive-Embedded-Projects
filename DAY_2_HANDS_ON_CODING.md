...
1. ✅ Connect your STM32F303 board
2. ✅ Create your first project in STM32CubeIDE
3. ✅ Write code to blink LED (LD3 - North LED)
4. ✅ Upload and run on REAL hardware!
5. ✅ Understand EVERY line of code
...
#### 3️⃣ Configure LED Pin (In CubeMX)

**Pin Configuration:**
1. In the pinout view, find **PE9**
2. Click on PE9 → Select **GPIO_Output**
3. Right-click PE9 → **User Label** → Type: `LED_NORTH`

**GPIO Settings:**
1. Click **System Core** → **GPIO**
...
2. Default is fine (8 MHz HSI → 72 MHz system clock)
...
#### Build the Project:
1. Click **Project** → **Build Project** (or Ctrl+B)
2. Wait for compilation
3. Check the **Console** - should say: `Build Finished. 0 errors`

#### Upload to Board:
1. Click **Run** → **Debug** (or F11)
...
**YOU JUST:**
- ✅ Wrote embedded C code
- ✅ Compiled it for ARM Cortex-M4
- ✅ Flashed it to real hardware
- ✅ Controlled physical hardware with code!

**You're now an embedded programmer!** 🚀
...
2. Configure more pins:
   - **PE10** → GPIO_Output → Label: `LED_EAST`
   - **PE12** → GPIO_Output → Label: `LED_WEST`
...
## 🎯 Today's Challenge (Do Before Day 3!)
...
**Pattern:**
- ON 100ms → OFF 100ms → ON 100ms → OFF 1000ms → REPEAT
...
- ✅ Pin configuration with CubeMX
- ✅ HAL library basics
- ✅ GPIO control (WritePin, TogglePin)
- ✅ Delay functions
- ✅ Build, flash, and debug workflow
- ✅ Experimented with real hardware!

### What You Built:
- ✅ Working LED blink program
- ✅ Multiple LED patterns
- ✅ Your first embedded C project on REAL hardware!
...
**Ready to try it? Let's BLINK THAT LED!** 💡🚀
